...
export const WALK_LOCATIONS: WalkLoc[] = [
  ...
  {
    id: 'shop', icon: 'gift', name: 'Лавка чудес',
    stories: [
      'В лавке продавались карманные радуги. Мы купили одну — для коллекции.',
      'Продавщица сказала, что я похож на маленькое облако. Мне понравилось.',
      'Мы долго выбирали открытку для тебя. Выбрали самую звёздную.',
    ],
  },
  {
    id: 'sight', icon: 'star', name: 'Смотровая площадка',
    stories: [
      'С высоты весь город выглядит как коробка со светлячками.',
      'Я махал пролетающим птицам. Одна махнула в ответ. Кажется.',
      'Мы загадали желание на закате. Я не скажу какое — сбудется само.',
    ],
  },
  {
