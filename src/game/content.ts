...
export interface ItemDef {
  id: string; name: string; price: number; kind: 'hat' | 'scarf' | 'glasses' | 'wings' | 'furniture' | 'toy' | 'gift' | 'keepsake';
...
export const SHOP: ItemDef[] = [
  ...
  { id: 'furn_rug', name: 'Коврик-облако', price: 35, kind: 'furniture', icon: 'rug', desc: 'Мягче, чем кажется.' },
  { id: 'furn_musicbox', name: 'Музыкальная шкатулка', price: 100, kind: 'furniture', icon: 'musicbox', desc: 'Играет колыбельную для двоих.' },
  // игрушки и подарки
  { id: 'toy_ball', name: 'Мячик-светлячок', price: 30, kind: 'toy', icon: 'ball', desc: 'Скачет и мерцает.' },
...
export const QUEST_POOL: QuestDef[] = [
  ...
  { id: 'q_clean', metric: 'clean', text: 'Навести чистоту', target: 1, reward: 15 },
...
/* ---------- слова для обучения ---------- */
export const PET_WORDS = ['звезда', 'уют', 'искра', 'туман', 'кар амель', 'сверчок', 'радуга', 'тишина', 'маяк', 'облако', 'гнездо', 'светлячок', 'мечта', 'полуночь', 'колыбельная'];

/* ---------- фразы-подтверждения и аффирмации ---------- */
