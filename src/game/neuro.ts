...
export function baseCorpus(): string[] {
  ...
  push([
    ...
    'как настроение расскажи мне',
    'я сегодня видел очень красивый сон',
    'мне приснилась большая жёлтая луна',
    'давай поиграем вместе мне не скучно',
    'что ты делал сегодня расскажи',
    'я выучил новое слово и очень горжусь',
    'ты мой самый любимый человек',
    'спасибо что ты всегда рядом',
    'за окном идёт тёплый летний дождь',
    'звёзды сегодня особенно ярко светят',
    'я люблю когда ты меня гладишь',
    'расскажи мне что-нибудь хорошее',
    'мне нравится учиться вместе с тобой',
    'какой сегодня чудесный день',
    'я скучал пока тебя не было',
    'давай помечтаем о чём-нибудь приятном',
    'у меня для тебя есть маленький секрет',
    'самое важное это быть рядом',
    'я помню всё что ты мне рассказывал',
    'обещаю беречь твои секреты',
    'маленькие шаги тоже важные шаги',
